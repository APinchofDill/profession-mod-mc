...
public class CommonConfig {
    ...
    protected ConfigurationNode generateConfig(CommentedConfigurationNode node) {
        try {
            ...
            node.node("autoJoinProfessions").set(false)
            ...
            node.node("preventLeavingProfession").set(false)
            ...
            node.node("useHardcoreDatapack").set(false)
                            .comment("""
            ...
            // announcements
            node.node("announce").node("levelUps").set(true)
